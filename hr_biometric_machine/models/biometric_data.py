...
class BiometricData(models.Model):
    ...
    @api.model
    def crate_attendance_in_openep_cron(self):
        """
        Call import function in biometric.data model
        """

        biometric_machine_obj = self.env['biometric.machine'].search([],limit=1)
        ...
        BiometricData.import_data_classmethod(
            biometric_machine_obj, biometric_data_obj, biometric_user_obj,)
